...
| Task | Metric | 2-bit per-expert (ours) | fp16 baseline (reference) |
|---|---|---|---|
| HellaSwag | acc_norm | **71.15%** | TBD |
| ARC-Easy | acc_norm | 74.33% | TBD |
| ARC-Challenge | acc_norm | 44.28% | TBD |
| PIQA | acc_norm | 77.97% | TBD |
| WikiText (lm-eval) | word_perplexity | 11.27 | TBD |

The TBD entries are pending evaluation of the fp16 baseline under the identical lm-evaluation-harness protocol; we expect these to land within the next 24 hours and to confirm the gaps observed in the perplexity-only Section 5.1.
